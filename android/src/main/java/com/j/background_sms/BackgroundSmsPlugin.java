...
public class BackgroundSmsPlugin implements FlutterPlugin, MethodCallHandler {
  ...
  public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
    if (call.method.equals("sendSms")) {
      ...
      Integer simSlot = call.argument("simSlot");
      sendMMS(num, msg, simSlot, result, img);
    }
    else {
  ...
  //https://github.com/aosp-mirror/platform_development/blob/master/samples/ApiDemos/src/com/example/android/apis/os/MmsMessagingDemo.java#L68
   private static final String TAG = "background_sms";
    ...
    private void sendMMS(String num, String msg, Integer simSlot, String filepath, Result result) {
    sendMessage(
                        mRecipientsInput.getText().toString(),
                        mSubjectInput.getText().toString(),
                        mTextInput.getText().toString());
